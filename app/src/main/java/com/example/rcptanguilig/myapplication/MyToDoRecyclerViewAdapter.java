...
import com.example.rcptanguilig.myapplication.dummy.DummyContent.DummyItem;
...
public class MyToDoRecyclerViewAdapter extends RecyclerView.Adapter<MyToDoRecyclerViewAdapter.ViewHolder> {
    ...
    private final ArrayList<ToDoItem> mValues;
    private final ToDoListFragment.OnListFragmentInteractionListener mListener;

    public MyToDoRecyclerViewAdapter(ArrayList<ToDoItem> items,
                                     ToDoListFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).toDo);
